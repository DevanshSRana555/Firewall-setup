...
![Open Tool](./assets/screenshots/(1)Defender_Firewall_service.png)
...
![Block Rule](./assets/screenshots/(2)Block_Telnet.png)

### 4. Test the Rule
Open **Command Prompt** and run:
`telnet localhost 23`
**Expected Result:** Connection failure (timeout or refused).
![Test Proof](./assets/screenshots/(3)Connection_proof.png)
